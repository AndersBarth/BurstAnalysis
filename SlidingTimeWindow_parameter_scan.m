...
save([foldername filesep files(1).name(1:end-6) '_STW_result.mat'],...
    'dt','dt_time','N_split','N_P','P','TPR','FDR','M','T','time_res','L');
...
set(gca,'CLim',[0,ceil(2.5*P/500)*500],'Box','on','LineWidth',lw,'FontSize',fs);
c = colorbar;
